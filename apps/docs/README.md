...
- `lib/source.ts`: Content source adapter; [`loader()`](https://fumadocs.dev/docs/headless/source-api) provides the interface to access your content.
...
Read the [Fumadocs MDX guide](https://fumadocs.dev/docs/mdx) for further details.
